        ...
        project.afterEvaluate {
            ...
            extension?.let {
                if (extension.includeCls) {
                    project.dependencies.add("implementation", "com.tencentcloudapi.cls:tencentcloud-cls-sdk-android:1.0.14")
                    project.dependencies.add("implementation", "com.tencentcloudapi.cls:cls-network-diagnosis-reporter-android:1.0.14")
                }
                ...
                if (extension.includeSLS) {
                    project.dependencies.add("implementation", "io.github.aliyun-sls:aliyun-log-android-sdk:2.7.0@aar")
                }
            }
        }
    }
